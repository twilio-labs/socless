This tutorial expands on the [Getting Started Tutorial](/getting-started) to introduce you to more advanced playbook development concepts. Specifically, you'll learn how to:
